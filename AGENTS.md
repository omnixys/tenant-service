...
> Repository development instructions for **tenant** (Service).
...
src/app.module.ts, config, health, prisma, tenant
...
node --test test/*.test.mjs (unit, error-contract); test:helm references deploy/helm/tenant-service

## Repository-Specific Rules

Tenant lifecycle is the platform-wide tenancy root; changes ripple across all services.
